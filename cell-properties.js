...
bold.addEventListener("click",(e)=>{
    ...
    //Modification
    cellProp.bold=!cellProp.bold;  //Data change performed here.
    cell.style.fontWeight=cellProp.bold ? "bold":"normal"; //UI change part1.
...
italic.addEventListener("click",(e)=>{
    ...
    //Modification
    cellProp.italic=!cellProp.italic;  //Data change performed here.
...
underline.addEventListener("click",(e)=>{
    ...
    let [cell,cellProp]=getCellAndCellProp(address);
    //Modification
    cellProp.underline=!cellProp.underline;  //Data change performed here.
